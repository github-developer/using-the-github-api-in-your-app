This is an example GitHub App that adds a label to all new issues opened in a repository. You can follow the "[Using the GitHub API in your app](https://developer.github.com/apps/quickstart-guide/using-the-github-api-in-your-app)" quickstart guide on developer.github.com to learn how to build the app code in `server.rb`.
